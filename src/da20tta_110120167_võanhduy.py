# -*- coding: utf-8 -*-
"""DA20TTA_110120167_VõAnhDuy.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PbiNK6pDnAc6S1DpPsU-jH0ylcEZ3ENc
...
"""## Phân loại 2 loài hoa tulips và daisy"""

import matplotlib.pyplot as plt
import matplotlib.image as mpimg

# Đường dẫn tới hai hình ảnh của bạn
image_path_1 = '/content/466486216_ab13b55763.jpg'
image_path_2 = '/content/5673728_71b8cb57eb.jpg'
...
plt.subplot(1, 2, 1)
plt.imshow(img1)
plt.title('Image 1: loài hoa rose')
plt.axis('off')  # Tắt trục

# Hiển thị hình ảnh thứ hai
plt.subplot(1, 2, 2)
plt.imshow(img2)
plt.title('Image 2: loài hoa daisy')
plt.axis('off')  # Tắt trục

plt.tight_layout()  # Đảm bảo bố cục hợp lý
plt.show()

"""## Chọn file ảnh để đọc"""

from google.colab import files
uploaded = files.upload()

"""## Load ảnh sau khí đã đọc"""
...
image_path = '/content/5673728_71b8cb57eb.jpg'

# Trích xuất tên của tệp từ đường dẫn
image_filename = os.path.basename(image_path)

# Load ảnh và chuẩn bị nó cho việc dự đoán
img = tf_image.load_img(image_path, target_size=(224, 224))
img_array = tf_image.img_to_array(img)
img_array = np.expand_dims(img_array, axis=0)
img_array = tf.keras.applications.mobilenet_v2.preprocess_input(img_array)

# Sử dụng mô hình phân loại đã được huấn luyện (ví dụ: MobileNetV2)
model = tf.keras.applications.MobileNetV2(weights='imagenet')
predictions = model.predict(img_array)

# Tên lớp có xác suất cao nhất
